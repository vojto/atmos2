...
(function() {
  ...
  Atmos = (function(_super) {
    ...
    Atmos.prototype.save = function(object, options) {
      return this.resources.save(object, options);
    };

    Atmos.prototype.execute = function() {
      var params, _ref;
      params = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return (_ref = this.resources).execute.apply(_ref, params);
    };
    ...
    Atmos.prototype.set_auth_key = function(key) {
      return this.authKey = key;
    };

    Atmos.prototype.has_auth_key = function() {
