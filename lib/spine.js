...
(function() {
  ...
  atmos_save = function(object, options) {
    var atmos, class_name, collection;
    atmos = Atmos.instance;
    class_name = object.constructor.className;
    collection = pluralize(class_name.toLowerCase());
    if (object.isNew()) {
      return atmos.create(collection, object.attributes(), options, function(object) {
        return console.log('create finished', object);
      });
    } else {
      return atmos.update(collection, object.attributes(), options, function(object) {
        return console.log('create finished', object);
      });
    }
  };
