(function() {
  ...
  ResourceClient = (function() {
    ...
    ResourceClient.prototype.fetch = function(model, options) {
      ...
      return this._request(path, {}, function(result) {
        ...
        for (_i = 0, _len = items.length; _i < _len; _i++) {
          item = items[_i];
          ids.push(_this._updateFromItem(collection, item, options));
        }
        console.log("IDs", ids);
    ...
    ResourceClient.prototype._updateFromItem = function(collection, item, options) {
      var uri;
      ...
      this.sync.updateOrCreate(uri, item);
