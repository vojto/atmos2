(function() {
  ...
  ResourceClient = (function() {
    ...
    ResourceClient.prototype.fetch = function(model, options) {
      ...
      return this._request(path, options.params, function(result) {
        ...
        if (options.remove === true) {
          _this._removeObjectsNotInList(collection, ids);
        }
    ...
    ResourceClient.prototype._removeObjectsNotInList = function(collection, ids) {
      return this.sync.removeObjectsNotInList(collection, ids);
    };
    ...
    ResourceClient.prototype.save = function(object, options) {
      ...
      path = this._findPath(uri.collection, options.action, options.pathParams);
      ...
      return this._request(path, data, function(result) {
        ...
        if (options.updateData != null) options.updateData(result);
    ...
    ResourceClient.prototype._request = function(path, params, callback) {
      ...
      proceed = function() {
        ...
        error = function(res, err) {
          ...
          return console.log("Fetch failed " + res + " " + err, res, err);
        };
        return $.ajax(url, {
          type: method,
          data: data,
