(function() {
  ...
  ResourceClient = (function() {
    ...
    ResourceClient.prototype.fetch = function(model, options) {
      ...
      ids = [];
      return this.request(path, {}, function(result) {
        var items;
    ...
    ResourceClient.prototype.save = function(object, options) {
      ...
      path = this._findPathForURI(uri, options.action, options);
    ...
    ResourceClient.prototype._findPathForObject = function(object, action, options) {
      var uri;
      uri = this.appContext.objectURI(object);
      return this._findPathForURI(uri);
    };

    ResourceClient.prototype._findPathForURI = function(uri, action, options) {
      var _base;
    ...
    ResourceClient.prototype.request = function(path, data, callback) {
      var proceed,
        _this = this;
      proceed = function() {
