(function() {
  ...
  Synchronizer = (function(_super) {
    ...
    function Synchronizer(options) {
      this.didPush = __bind(this.didPush, this);      this.messageClient = new MessageClient(this);
    ...
    Synchronizer.prototype.connect = function() {
      ...
      return this.messageClient.connect(function() {
        return _this.messageClient.send("client-connect", {
